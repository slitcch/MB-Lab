...
#creates new object
# IS used.
# Oh it's used in hair_engine, hmm.
...
# seems to be from https://github.com/Noizirom/Pino_kio-Ragdoll-Engine/blob/master/Pino_kio_Ragdoll_Engine.py
